...
public class VistaMolotovEnemigaLopezReggae {

	static Image bomb1 = new ImageIcon("drawable/bomb3.png").getImage();
	static Image bomb2 = new ImageIcon("drawable/bomb4.png").getImage();
