...
public class VistaMolotovEnemigaLopezReggaeAlado {

	static Image bomb1 = new ImageIcon("drawable/bomb6.png").getImage();
	static Image bomb2 = new ImageIcon("drawable/bomb5.png").getImage();
